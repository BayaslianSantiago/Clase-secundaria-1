...
st.markdown("""
    ...
    /* Títulos en azul brillante (celeste) para resaltar en oscuro */
...
if slide_activa == "1. Presentación":
    ...
    with tab2:
        st.code("# Toma de decisiones lógicas\npuntos = 15\n\nif puntos > 10:\n    print('¡Ganaste la partida!')\nelse:\n    print('Sigue intentando')", language="python")
        
    with tab3:
        st.code("# Automatizar tareas repetitivas\nfor i in range(5):\n    print('Esta instrucción se repite cinco veces')", language="python")
